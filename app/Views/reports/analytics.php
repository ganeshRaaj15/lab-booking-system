...
<div class="slams-page-header">
    <div class="slams-page-header-left">
        <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
            <span class="badge rounded-pill text-bg-primary" style="font-size:0.74rem;letter-spacing:0.04em">
    ...
    <div class="slams-page-header-actions">
        <button class="btn btn-glass btn-sm" type="button"
                data-bs-toggle="collapse" data-bs-target="#rptFilterPanel"
                aria-expanded="false" aria-controls="rptFilterPanel">
...
<div class="collapse" id="rptFilterPanel">
...
<?php if (! empty($report['limitations'])): ?>
    <div class="card border-0 shadow-sm mt-2">
        <div class="card-body py-3">
            ...
            <ul class="mb-0 ps-3" style="font-size:0.81rem;color:var(--slams-muted)">
