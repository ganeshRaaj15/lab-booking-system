        ...
        <div class="card-body">
            <form method="get" action="/admin/reservations" class="row g-3 align-items-end">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="/admin/reservations" class="btn btn-outline-secondary"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
            <div class="small text-muted mt-3">Showing <?= esc(count($reservations)) ?> reservation(s).</div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            <?php if (empty($reservations)): ?>
                <div class="text-center text-muted py-5">No reservations found. <a href="/admin/reservations/create">Add one</a>.</div>
            <?php else: ?>
                            ...
                            <?php foreach ($reservations as $r): ?>
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap">
                                        <a href="/admin/reservations/edit/<?= esc($r['id']) ?>" class="btn btn-sm btn-outline-secondary me-1">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="/admin/reservations/delete/<?= esc($r['id']) ?>" method="post" class="d-inline">
                                            <?= csrf_field() ?>
