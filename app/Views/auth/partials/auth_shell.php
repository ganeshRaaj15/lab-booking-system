        ...
        <div class="auth-shell__form-card">
            ...
            <div class="auth-shell__switcher" role="tablist" aria-label="Authentication pages">
                <a
                    ...
                    href="<?= site_url('/login') ?>"
                    class="auth-shell__switcher-link<?= $authMode === 'login' ? ' is-active' : '' ?>"
                ...
                <a
                    ...
                    class="auth-shell__switcher-link<?= $authMode === 'register' ? ' is-active' : '' ?>"
            ...
            >
                ...
                <?php if (session()->has('errors') && $authMode === 'login'): ?>
                    <div class="alert alert-danger">
                        <i class="bi bi-exclamation-triangle me-2"></i>
            ...
            >
                ...
                <?php if (session()->has('errors') && $authMode === 'register'): ?>
                    <div class="alert alert-danger">
                        <?php foreach ((array) session('errors') as $error): ?>
                            <div><?= esc($error) ?></div>
                        <?php endforeach; ?>
